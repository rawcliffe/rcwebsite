...
function consulting_thinkup_frontscripts() {
	...
	//Add Custom JS For Quoting Functionality - NW 
	wp_enqueue_script( 'submit-quote', get_template_directory_uri() . '/lib/scripts/submit-quote-ajax.js', array( 'jquery' ), '1.0.0', 'true' );
...
//----------------------------------------------------------------------------------
//	Custom Code For Quoting Functionality - NW ####
//  References:
//	https://teamtreehouse.com/community/submitting-a-form-in-wordpress-using-ajax
//	https://samelh.com/blog/2015/08/13/create-mysql-database-table-wordpress-insert-data-wpdb-html-form/
//----------------------------------------------------------------------------------
...
function quote_form()
{
	$name = $_POST['name'];  
	$email = $_POST['email'];
	echo $name. ' just sent an ajax request. Email is: '. $email;
	wp_die();
}